...
import view.components.buttonAction.AtualizarPaginaAction;
import view.components.buttonAction.MudarPaginaAction;
import view.style.MyStyleConstantsFactory;
...
public abstract class DefaultLayout implements TelaLayoutInterface {
    ...
    public Parent createNav() {
        ...
        menuBarEsquerdo.getMenus().addAll(createMenuTema(), createMenuConfig());

        MenuBar loginbar = ComponentsAbstractFactory.factory.createMenuBar("right");
        loginbar.getMenus().addAll(createMenuLogin());
    ...
    public Menu createMenuConfig() {
        ...
        menuItemTema6.setOnAction(event -> {
            MyStyleConstantsFactory.TEMA_6.createStyle();
            new AtualizarPaginaAction().active();
